            ...
            (i = [
                {
                    key: "sweetAlert2",
                    value: function () {
                        var n = Swal.mixin({ buttonsStyling: !1, customClass: { confirmButton: "btn btn-success m-1", cancelButton: "btn btn-danger m-1", input: "form-control" } });
                        jQuery(".js-swal-simple").on("click", function (e) {
                            ...
                            jQuery(".js-swal-success").on("click", function (e) {
                                n.fire("Success", "Everything was updated perfectly!", "success");
                            }),
                            jQuery(".js-swal-info").on("click", function (e) {
                                ...
                                //     }
                                // });
                                n.fire("sss", "Just an informational message!", "ss");
                            }),
                            ...
                            jQuery(".js-swal-confirm").on("click", function (e) {
                                n.fire({
                                    ...
                                    e.value ? n.fire("Deleted!", "Your imaginary file has been deleted.", "success") : "cancel" === e.dismiss && n.fire("Cancelled", "Your imaginary file is safe :)", "error");
                                });
                            }),
                            jQuery(".js-swal-custom-position").on("click", function (e) {
                                n.fire({ position: "top-end", title: "Perfect!", text: "Nice Position!", icon: "success" });
                            });
                    },
                },
                {
