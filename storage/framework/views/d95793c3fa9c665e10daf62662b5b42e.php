<script>
    ...
    function getDataTask() {
        ...
        $.ajax({
            url: "<?php echo e(route('task.data')); ?>",
            type: "GET",
            dataType: "json",
            data: {
                hotels,
    ...
    function ViewTask(TaskId) {
        ...
        $.ajax({
            url: "<?php echo e(url('task/show')); ?>" + '/' + TaskId,
            dataType: "json",
            type: 'GET',
            success: function(data) {
                console.log(data);
    ...
    function buildTask(task) {
        ...
        if (task.status_id == 2) {
            if ("<?php echo e(Auth::id()); ?>" == task.worker_id || "<?php echo e(check_create_permission('8')); ?>") {
                output += `
                    <tr>
                        <td style="width:20%"><i class="fa fa-gem   text-muted mr-1" > Actions</td>
                        <td><a href="<?php echo e(url('task/change_status/${task.id}/3')); ?>"><button class="btn bg-flat-light" > <i class="fa fa-check"></i>  Confirm</button></a></td>
                    </tr>
                `
            }
...
<?php /**PATH /home/sunrise/public_html/tickets/resources/views/tasks/scripts.blade.php ENDPATH**/ ?>