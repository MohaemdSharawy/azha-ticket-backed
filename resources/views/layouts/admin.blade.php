...
<head>
    ...
    <link rel="icon" type="image/png" sizes="192x192"
        href="{{ URL::asset('admin/assets/media/favicons/favicon-192x192.png') }}">
    <link rel="apple-touch-icon" sizes="180x180"
        href="{{ URL::asset('admin/assets/media/favicons/apple-touch-icon-180x180.png') }}">
    <!-- END Icons -->
...
<body>
            ...
            <div class="content-header border-bottom">
                ...
                <a class="img-link mr-1" href="javascript:void(0)">
                    <img class="img-avatar img-avatar32"
                        src="{{ URL::asset('admin/assets/media/avatars/avatar10.jpg') }}" alt="">
                </a>
                <!-- END User Avatar -->
                                    ...
                                    <ul class="nav-items mb-0">
                                            ...
                                            <a class="media py-2" href="javascript:void(0)">
                                                <div class="mr-3 ml-2 overlay-container overlay-bottom">
                                                    <img class="img-avatar img-avatar48"
                                                        src="{{ URL::asset('admin/assets/media/avatars/avatar7.jpg') }}"
                                                        alt="">
                                                    <span
                                        ...
                                        <li>
                                            <a class="media py-2" href="javascript:void(0)">
                                                <div class="mr-3 ml-2 overlay-container overlay-bottom">
                                                    <img class="img-avatar img-avatar48"
                                                        src="{{ URL::asset('admin/assets/media/avatars/avatar12.jpg') }}"
                                                        alt="">
                                                    <span
                                                        class="overlay-item item item-tiny item-circle border border-2x border-white bg-success"></span>
                                                </div>
                                        ...
                                        <li>
                                            <a class="media py-2" href="javascript:void(0)">
                                                <div class="mr-3 ml-2 overlay-container overlay-bottom">
                                                    <img class="img-avatar img-avatar48"
                                                        src="{{ URL::asset('admin/assets/media/avatars/avatar6.jpg') }}"
                                                        alt="">
                                                    <span
                                                        class="overlay-item item item-tiny item-circle border border-2x border-white bg-success"></span>
                                                </div>
                                        ...
                                        <li>
                                            <a class="media py-2" href="javascript:void(0)">
                                                <div class="mr-3 ml-2 overlay-container overlay-bottom">
                                                    <img class="img-avatar img-avatar48"
                                                        src="{{ URL::asset('admin/assets/media/avatars/avatar5.jpg') }}"
                                                        alt="">
                                                    <span
                                        ...
                                        <li>
                                            <a class="media py-2" href="javascript:void(0)">
                                                <div class="mr-3 ml-2 overlay-container overlay-bottom">
                                                    <img class="img-avatar img-avatar48"
                                                        src="{{ URL::asset('admin/assets/media/avatars/avatar14.jpg') }}"
                                                        alt="">
                                                    <span
                                                        class="overlay-item item item-tiny item-circle border border-2x border-white bg-warning"></span>
                                                </div>
            ...
            <div class="js-sidebar-scroll">
                ...
                <div class="content-side">
                    <ul class="nav-main">
                        ...
                        <li class="nav-main-item">
                            <a class="nav-main-link active" href="{{ route('posts') }}">
                        ...
                        <li class="nav-main-item">
                            <a class="nav-main-link active" href="{{ route('violations') }}">
                                <i class="nav-main-link-icon  fa fa-window-close"></i>
                                <span class="nav-main-link-name">Violations</span>
                            </a>
                        </li>
                        <li class="nav-main-item">
                            <a class="nav-main-link active" href="{{ route('discover') }}">
                        ...
                        <li class="nav-main-item">
                            <a class="nav-main-link active" href="{{ route('discover-category') }}">
                                <i class="nav-main-link-icon  fa fa-map"></i>
                                <span class="nav-main-link-name">Discover Category</span>
                            </a>
                        </li>
                        <li class="nav-main-item">
                            <a class="nav-main-link active" href="{{ route('discover') }}">
                        ...
                        <li class="nav-main-item">
                            <a class="nav-main-link active" href="{{ route('payment') }}">
                                <i class="nav-main-link-icon  fa fa-dollar-sign"></i>
                                <span class="nav-main-link-name">Payment Requests</span>
                            </a>
                        </li>
                        ...
                        <li class="nav-main-item">
                            ...
                            <ul class="nav-main-submenu">
                                ...
                                @endif
                                @if ($service_permission && Auth::user()->is_admin == '1')
                                    <li class="nav-main-item">
                                ...
                                @endif
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="{{ route('category_service') }}">
                                        <span class="nav-main-link-name">Category Services</span>
                                    </a>
                                </li>
                                {{-- <li class="nav-main-item">
                        ...
                        <li class="nav-main-heading">Admin Control</li>
                        ...
                        <li class="nav-main-item">
                            ...
                            <ul class="nav-main-submenu">
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="{{ route('report') }}">
                                        <span class="nav-main-link-name">General Report</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="{{ route('report.worker') }}">
                                        <span class="nav-main-link-name">Worker Reports</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="{{ route('report.department') }}">
                                        <span class="nav-main-link-name">Department Report</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="{{ route('report.top_ten') }}">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="custom-control custom-switch mb-1">
                        <input type="checkbox" class="custom-control-input" id="example-switch-custom1"
                            name="can_login" value="1" @if (Auth::user()->notify == 1) checked @endif
                    ...
                    <div class="dropdown d-inline-block ml-2">
                        <button type="button" class="btn btn-sm btn-dual d-flex align-items-center"
                            ...
                            <img class="rounded-circle"
                                src="{{ URL::asset('admin/assets/media/avatars/avatar10.jpg') }}" alt="Header Avatar"
                                style="width: 21px;">
                                    ...
                                    @foreach (Auth::user()->unreadNotifications as $notification)
                                        <li>
                                            <a class="text-dark media py-2"
                                                @if ($notification->type == 'App\Notifications\TicketNotification') onclick="ViewTicket('{{ $notification->data['id'] }}')"
                                                @elseif ($notification->type == 'App\Notifications\TaskNotification')
                                                onclick="ViewTask('{{ $notification->data['id'] }}')" @endif>
                                                <div class="mr-2 ml-3">
    ...
    <script src="{{ URL::asset('admin/assets/js/moment/moment.js') }}"></script>
