                        ...
                        <div class="block-content">
                            <form class="js-validation" method="POST" action="">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class=" form-control boot-select" id="dpe_id" name="dep_id" required
                                ...
                                <div class="form-group">
                                    <label for="example-ltf-email2">Status*</label>
                                    <select class=" form-control boot-select" name="status_id" data-live-search="true">
                                        <option></option>
                                        @foreach ($status as $stat)
                                            <option value="{{ $stat->id }}" name="{{ $stat->name }}">
                                                {{ $stat->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <button class="btn btn-info"
                                    formaction="{{ route('report.ticket.generate') }}">Generate</button>
                                <button class="btn btn-info" formaction="{{ route('excel.department.report') }}">Generate
                                    Excel</button>
                                <br><br>
                            </form>
                        </div>
