...
<head>
    ...
    <link rel="stylesheet" id="css-main" href="{{ URL::asset('admin/assets/css/oneui.min.css') }}">
    <link rel="stylesheet" href="{{ URL::asset('admin/assets/js/plugins/summernote/summernote-bs4.css') }}">
    <link rel="stylesheet" href="{{ URL::asset('admin/assets/js/plugins/simplemde/simplemde.min.css') }}">

    <link rel="stylesheet" type="text/css" href="{{ URL::asset('css/dropzone.min.css') }}">
    {{-- <link rel="stylesheet" type="text/css" href="{{URL::asset('css/dropzone.css')}}"> --}}
    <script src="{{ URL::asset('js/dropzone.min.js') }}"></script>


    {{-- <link href="{{ URL::asset('css/summernote-bs4.css') }}" rel="stylesheet">
...
<body>
    ...
    <div id="page-container" class="sidebar-o sidebar-dark enable-page-overlay side-scroll page-header-fixed main-content-narrow">
        ...
        <aside id="side-overlay">
            ...
            <div class="content-header border-bottom">
                ...
                <a class="img-link mr-1" href="javascript:void(0)">
                    <img class="img-avatar img-avatar32" src="{{ URL::asset('admin/assets/media/avatars/avatar10.jpg') }}" alt="">
                </a>
                <!-- END User Avatar -->
                                ...
                                <div class="block-content">
                                    ...
                                    <ul class="nav-items mb-0">
                                        <li>
                                            <a class="media py-2" href="javascript:void(0)">
                                                <div class="mr-3 ml-2 overlay-container overlay-bottom">
                                                    <img class="img-avatar img-avatar48" src="{{ URL::asset('admin/assets/media/avatars/avatar7.jpg') }}" alt="">
                                        ...
                                        <li>
                                            <a class="media py-2" href="javascript:void(0)">
                                                <div class="mr-3 ml-2 overlay-container overlay-bottom">
                                                    <img class="img-avatar img-avatar48" src="{{ URL::asset('admin/assets/media/avatars/avatar12.jpg') }}" alt="">
                                                    <span class="overlay-item item item-tiny item-circle border border-2x border-white bg-success"></span>
                                                </div>
                                                <div class="media-body">
                                        ...
                                        <li>
                                            <a class="media py-2" href="javascript:void(0)">
                                                <div class="mr-3 ml-2 overlay-container overlay-bottom">
                                                    <img class="img-avatar img-avatar48" src="{{ URL::asset('admin/assets/media/avatars/avatar6.jpg') }}" alt="">
                                                    <span class="overlay-item item item-tiny item-circle border border-2x border-white bg-success"></span>
                                                </div>
                                                <div class="media-body">
                                        ...
                                        <li>
                                            <a class="media py-2" href="javascript:void(0)">
                                                <div class="mr-3 ml-2 overlay-container overlay-bottom">
                                                    <img class="img-avatar img-avatar48" src="{{ URL::asset('admin/assets/media/avatars/avatar5.jpg') }}" alt="">
                                        ...
                                        <li>
                                            <a class="media py-2" href="javascript:void(0)">
                                                <div class="mr-3 ml-2 overlay-container overlay-bottom">
                                                    <img class="img-avatar img-avatar48" src="{{ URL::asset('admin/assets/media/avatars/avatar14.jpg') }}" alt="">
                                                    <span class="overlay-item item item-tiny item-circle border border-2x border-white bg-warning"></span>
                                                </div>
                                                <div class="media-body">
                    ...
                    <ul class="nav-main">
                        ...
                        <li class="nav-main-item">
                            <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="false" href="#">
                                ...
                                <span class="nav-main-link-name">Main Menue</span>
                            </a>
                            <ul class="nav-main-submenu">
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="{{ route('ticket') }}">
                                        <span class="nav-main-link-name">Tickets</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="{{ route('facility') }}">
                                        <span class="nav-main-link-name">Facilities</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="{{ route('services') }}">
                                        <span class="nav-main-link-name">Services</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="{{ route('workers') }}">
                                        <span class="nav-main-link-name">Workers</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="{{ route('task') }}">
                                        <span class="nav-main-link-name">Tasks</span>
                                    </a>
                                </li>
                                {{-- <li class="nav-main-item">
                                    <a class="nav-main-link" href="{{ route('mailSetup') }}">
                                <span class="nav-main-link-name">Mail Setup</span>
                                </a>
                        </li> --}}
                    </ul>
                    </li>
                    @if ($hotel_module || $user_module || $dep_module)
                    <li class="nav-main-item">
                        <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="false" href="#">
                        ...
                        <ul class="nav-main-submenu">
                            @if ($hotel_module)
                            <li class="nav-main-item">
                                <a class="nav-main-link" href="{{ route('hotels') }}">
                            ...
                            @if ($log_module)
                            <li class="nav-main-item">
                                <a class="nav-main-link" href="{{ route('log') }}">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="dropdown d-inline-block ml-2">
                        <button type="button" class="btn btn-sm btn-dual d-flex align-items-center" id="page-header-user-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="rounded-circle" src="{{ URL::asset('admin/assets/media/avatars/avatar10.jpg') }}" alt="Header Avatar" style="width: 21px;">
                            <span class="d-none d-sm-inline-block ml-2">{{ Auth::user()->name }}</span>
                            <i class="fa fa-fw fa-angle-down d-none d-sm-inline-block ml-1 mt-1"></i>
                        </button>
                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-right p-0 border-0" aria-labelledby="page-header-user-dropdown">
                            <div class="p-3 text-center bg-primary-dark rounded-top">
                                <img class="img-avatar img-avatar48 img-avatar-thumb" src="{{ URL::asset('admin/assets/media/avatars/avatar10.jpg') }}" alt="">
                            ...
                            <div class="p-2">
                                ...
                                <a class="dropdown-item d-flex align-items-center justify-content-between" data-toggle="modal" data-target="#passwordChange">
                    ...
                    <div class="block block-rounded block-themed block-transparent mb-0">
                        ...
                        <div class="block-content block-content-full">
                            <div class="row gutters-tiny">
                                <div class="col-6">
                                    <!-- CRM -->
                                    <a class="block block-rounded block-link-shadow bg-body" href="https://crm.sunrise-resorts.com/authentication/admin">
                                ...
                                <div class="col-6">
                                    <!-- Products -->
                                    <a class="block block-rounded block-link-shadow bg-body" href="https://newsign.sunrise-resorts.com">
                                        <div class="block-content text-center">
                                ...
                                <div class="col-6">
                                    <!-- Sales -->
                                    <a class="block block-rounded block-link-shadow bg-body mb-0" href="https://hrsign.sunrise-resorts.com">
                                        <div class="block-content text-center">
                                ...
                                <div class="col-6">
                                    <!-- Payments -->
                                    <a class="block block-rounded block-link-shadow bg-body mb-0" href="https://srp.sunrise-resorts.com">
                                        <div class="block-content text-center">
        ...
        <div class="modal fade confirmation" id="passwordChange" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" {{-- <form method="POST" action="{{ route('update.user.password') }}" --}} enctype="multipart/form-data">
                            @csrf
                            <label>Password</label>
                            <input type="password" class="form-control" name="password" required placeholder="Password">
                            <br>
                            <label>Password Confirm</label>
                            <input type="password" class="form-control" name="password_confirm" required placeholder="Password">
                            <br>
                    </div>
    ...
    <script src="{{ URL::asset('admin/assets/js/oneui.core.min.js') }}"></script>

    <script src="{{ URL::asset('admin/assets/js/oneui.app.min.js') }}"></script>

    <!-- Page JS Plugins -->
    <script src="{{ URL::asset('admin/assets/js/plugins/jquery-sparkline/jquery.sparkline.min.js') }}"></script>
    <script src="{{ URL::asset('admin/assets/js/plugins/chart.js/Chart.bundle.min.js') }}"></script>
    <script src="{{ URL::asset('admin/assets/js/plugins/bootstrap-notify/bootstrap-notify.min.js') }}"></script>
    <script src="{{ URL::asset('admin/assets/js/plugins/ckeditor/ckeditor.js') }}"></script>
    <script src="{{ URL::asset('admin/assets/js/plugins/summernote/summernote-bs4.min.js') }}"></script>
    <script src="{{ URL::asset('admin/assets/js/plugins/simplemde/simplemde.min.js') }}"></script>



    {{--
    <script src="{{ URL::asset('js/summernote-bs4.js') }}"></script>
