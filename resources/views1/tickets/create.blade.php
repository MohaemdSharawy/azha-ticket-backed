                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 ">
                                                <div class="form-group">
                                                    ...
                                                    <select class=" js-select2 form-control " name="hid" required
                                                        id="h_id">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 ">
                                                <div class="form-group">
                                                    ...
                                                    <select class="js-select2 form-control" id="type_id" name="type_id"
                                                        onchange="typeChange()" required>
                                                        <option></option>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 ">
                                                <div class="form-group">
                                                    ...
                                                    <select class="js-select2 form-control" name="dep" id="dep"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 ">
                                                <div class="form-group">
                                                    ...
                                                    <select class="js-select2 form-control" name="priority_level" required>
                                                        <option></option>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 ">
                                                <div class="form-group" id="rooms">
                                                    ...
                                                    <select class="js-select2 form-control " data-live-search="true"
